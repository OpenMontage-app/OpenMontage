<div align="center">
  <a href="../../releases/latest">
    <img width="255" alt="OpenMontage." src="assets/logo.png" />
  </a>
</div>
...
|----------|----------|-----|
| **Windows x64** | [OpenMontage-x64.7z](../../releases) | Run installer → launch `OpenMontage-x64.exe` |
| **Linux x64** | [OpenMontage-Linux-x64.run](../../releases) | `chmod +x` → run installer |
| **macOS Apple Silicon** | [OpenMontage-macOS-arm64.dmg](../../releases) | Open DMG → drag to Applications |
